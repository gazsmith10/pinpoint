...
namespace PinPoint\TechTest\Controller\Adminhtml\logo;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('PinPoint_TechTest::Logo')
            ->addBreadcrumb(__('PinPoint TechTest'), __('PinPoint TechTest'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('PinPoint\TechTest\Model\Logo');
        ...
        $this->_coreRegistry->register('logo', $model);
